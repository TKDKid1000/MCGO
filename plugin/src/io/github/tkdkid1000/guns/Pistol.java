...
public class Pistol extends Gun {
	...
	public Pistol(MCGO mcgo, String key, Material mat, String name, int maxammo, long delay, long reloadtime, double speed,
			double damage, boolean fireball, int fireticks) {
