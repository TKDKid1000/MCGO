...
public class CustomShootSequence extends Gun {

	// Just gonna steal the original shotguns code...
	public CustomShootSequence(MCGO mcgo, String key, Material mat, String name, int maxammo, long delay,
			long reloadtime, double speed, double damage, boolean fireball, int fireticks) {
